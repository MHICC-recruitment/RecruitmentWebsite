...
constructor(props) {
  ...
  this.state = {
    etudes: [
      {id: 1, name: "Diabète de type 2", title: "Développement d'un nouveau médicament", ageMin:40, ageMax:50, sexe:"FM", lien:"\EtudeDiabete", date:"19 mars 2019"},
      {id: 2, name: "Scoliose", title:"Développemen d'un nouveau traitement", ageMin:50, ageMax:60, sexe:"M", lien:"\EtudeScoliose", date:"25 février 2019"},
      {id: 3, name: "Maladie rare", title:"Développement d'une nouvelle méthode", ageMin:60, ageMax:70, sexe:"F", lien:"\EtudeMR", date:"12 juin 2019"},
      {id: 4, name: "Hypertension", title:"Développement d'une nouvelle méthode", ageMin:50, ageMax:70, sexe:"F", lien:"\EtudeHP", date:"15 avril 2019"}
    ],
  etudeSelect:'',
  ageSelect:'',
  sexeSelect:''
